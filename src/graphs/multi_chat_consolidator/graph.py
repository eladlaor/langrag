...
def _send_newsletter_email(recipients: list, html_path: str, data_source: str, start_date: str, end_date: str, base_url: str = "") -> None:
    ...
    from core.delivery.email_factory import render_email_template

    html_body = render_email_template(
        "newsletter_notification.html",
        data_source_display=data_source.replace("_", " ").title(),
...
def build_parallel_orchestrator_graph(checkpointer=None) -> StateGraph:
    ...
    builder.add_edge(NodeNames.MultiChatConsolidator.RELATED_LINKS_ENRICHMENT, NodeNames.MultiChatConsolidator.TRANSLATE_CONSOLIDATED_NEWSLETTER)
