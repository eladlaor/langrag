...
from constants import LlmInputPurposes, LLMCallType, MessageRole, OPENAI_VISION_DETAIL_LOW
...
class OpenAIProvider(PromptInputBuilderMixin, LLMProviderInterface):
    """
